# copied from here which is currently on master
# https://github.com/huggingface/datasets/blob/ac9c70b10e6b7c020ef52c5dd6ab8a630504e1dc/datasets/wikipedia/wikipedia.py
# and comment out one line.
# | "Distribute" >> beam.transforms.Reshuffle()
# see https://github.com/huggingface/datasets/issues/1790
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            features=datasets.Features(
                {"title": datasets.Value("string"), "text": datasets.Value("string")}
            ),
